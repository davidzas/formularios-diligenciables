...
@Component({
  selector: 'app-pqr-peticion',
  templateUrl: './pqr-peticion.component.html',
  styleUrls: ['./pqr-peticion.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PqrPeticionComponent implements OnInit {
  ...
  descargarPdf() {
    ...
    setTimeout(_ => {
      kendo.drawing.drawDOM(jQuery(".formulariopt"), {
        forcePageBreak: ".page-break", paperSize: "Legal", scale: 0.48
      }).then((group) => {
        kendo.drawing.pdf.saveAs(group, "formato_peticion.pdf");
